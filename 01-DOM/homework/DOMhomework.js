...
let Presentacion= document.querySelector('#createdBy');

Presentacion.innerHTML='Aplicación creada por: Martin Alexis';
...
function addToDo() {
  ...
  let nuevoToDo= new ToDo(texto.value);
